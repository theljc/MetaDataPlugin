...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnAssetDeleted, const FString&, AssetPath);
...
public:
	...
	void AddTagFromAssetRegistry(const FName TagToAdd, UObject* Asset);
	...
	// 注册标签到全局资产注册表
	void OnTagFirstAdded(const FName TagToAdd, UObject* Asset);
